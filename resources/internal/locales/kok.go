...
func Get_kok() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.CG:    "कोंगो (प्रजासत्ताक)",
			territory.CH:    "स्विट्ज़रलैंड",
			territory.CI:    "आयवोरी कोस्ट",
			...
			territory.FI:    "फिनलँड",
			territory.FJ:    "फिजी",
			territory.FK:    "फ़ॉकलैंड आइलैंड्स (इलास मालविनास)",
