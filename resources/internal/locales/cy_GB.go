...
func Get_cy_GB() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.CD:    "Y Congo (G.Dd.C.)",
			territory.CF:    "Gweriniaeth Canolbarth Affrica",
			territory.CG:    "Y Congo (Gweriniaeth)",
			territory.CH:    "Y Swistir",
			territory.CI:    "Arfordir Ifori",
			...
			territory.CY:    "Cyprus",
			territory.CZ:    "Gweriniaeth Tsiec",
			...
			territory.FJ:    "Fiji",
			territory.FK:    "Ynysoedd y Falkland (Ynysoedd y Malfinas)",
