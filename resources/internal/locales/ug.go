...
func Get_ug() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.CD:    "كونگو (ك د ج)",
			territory.CF:    "ئوتتۇرا ئافرىقا جۇمھۇرىيىتى",
			territory.CG:    "كونگو (جۇمھۇرىيىتى)",
			territory.CH:    "شىۋېتسارىيە",
			territory.CI:    "پىل چىشى قىرغىقى",
