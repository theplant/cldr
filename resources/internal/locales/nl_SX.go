...
func Get_nl_SX() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.CG:    "Congo (Republiek)",
			territory.CH:    "Zwitserland",
			territory.CI:    "Republiek Ivoorkust",
			...
			territory.CY:    "Cyprus",
			territory.CZ:    "Tsjechische Republiek",
			...
			territory.FJ:    "Fiji",
			territory.FK:    "Falklandeilanden (Islas Malvinas)",
			...
			territory.TL:    "Democratische Republiek Oost-Timor",
