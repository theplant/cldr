...
func Get_be() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.CD:    "Конга (ДРК)",
			territory.CF:    "Цэнтральна-Афрыканская Рэспубліка",
			territory.CG:    "Рэспубліка Конга",
			territory.CH:    "Швейцарыя",
			territory.CI:    "Бераг Слановай Косці",
			...
			territory.CY:    "Кіпр",
			territory.CZ:    "Чэшская Рэспубліка",
			...
			territory.FJ:    "Фіджы",
			territory.FK:    "Фалклендскія (Мальвінскія) астравы",
