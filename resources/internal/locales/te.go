...
func Get_te() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.CD:    "కాంగో (DRC)",
			territory.CF:    "సెంట్రల్ ఆఫ్రికన్ రిపబ్లిక్",
			territory.CG:    "కాంగో (రిపబ్లిక్)",
			territory.CH:    "స్విట్జర్లాండ్",
			territory.CI:    "ఐవరీ కోస్ట్",
			...
			territory.FJ:    "ఫిజీ",
			territory.FK:    "ఫాక్\u200cల్యాండ్ దీవులు (ఇస్లాస్ మాల్వినాస్)",
