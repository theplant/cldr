...
func Get_mk() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.FI:    "Финска",
			territory.FJ:    "Фиџи",
			territory.FK:    "Фолкландски Острови (Малвински Острови)",
