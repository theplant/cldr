...
func Get_pl_PL() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.CG:    "Republika Konga",
			territory.CH:    "Szwajcaria",
			territory.CI:    "Wybrzeże Kości Słoniowej",
