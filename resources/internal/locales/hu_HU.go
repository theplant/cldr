...
func Get_hu_HU() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.CD:    "Kongó (KDK)",
			territory.CF:    "Közép-afrikai Köztársaság",
			territory.CG:    "Kongó (Köztársaság)",
			territory.CH:    "Svájc",
			...
			territory.FJ:    "Fidzsi",
			territory.FK:    "Falkland-szigetek (Malvin-szigetek)",
