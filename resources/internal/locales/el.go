...
func Get_el() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.CD:    "Κονγκό (ΛΔΚ)",
			territory.CF:    "Κεντροαφρικανική Δημοκρατία",
			territory.CG:    "Κονγκό (Δημοκρατία)",
			...
			territory.CY:    "Κύπρος",
			territory.CZ:    "Τσεχική Δημοκρατία",
			...
			territory.FJ:    "Φίτζι",
			territory.FK:    "Νήσοι Φόκλαντ (Νήσοι Μαλβίνας)",
