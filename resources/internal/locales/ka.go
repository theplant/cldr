...
func Get_ka() *cldr.Locale {
	return &cldr.Locale{
		...
		Territories: cldr.Territories{
			...
			territory.CD:    "კონგო (კონგოს დემოკრატიული რესპუბლიკა)",
			territory.CF:    "ცენტრალური აფრიკის რესპუბლიკა",
			territory.CG:    "კონგო (რესპუბლიკა)",
			territory.CH:    "შვეიცარია",
			territory.CI:    "სპილოს ძვლის სანაპირო",
			...
			territory.CZ:    "ჩეხეთის რესპუბლიკა",
			...
			territory.TL:    "აღმოსავლეთ ტიმორი",
